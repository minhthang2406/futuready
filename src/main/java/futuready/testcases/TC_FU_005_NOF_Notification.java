...
public class TC_FU_005_NOF_Notification {
  ...
  @Test (enabled=true)
  public void TC_FU_005_NOF_01_User_can_navigate_to_notification_page () throws Exception {
	  ...
	  dashboard.click_on_notification_button();
  }
